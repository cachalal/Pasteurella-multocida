...
```{r}
all_Sulfa <- data.frame(CONC_TMP=seq(0, 70, by=0.1))  # creer un range de concentrations en ATB pour fitter le modèle, adapté au range existant dans les manips (exemple sulfa seul, aller de 0 à 512)
